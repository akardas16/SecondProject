...
struct ModalSheet: View {
    ...
    var body: some View {
        ...
        }.frame(maxWidth:.infinity,maxHeight: .infinity,alignment: .center).ignoresSafeArea().animation(.spring(), value: isShowing)
    }
    ...
    var mainView: some View {
        VStack{
            ...
            .animation(isDragging ? nil : .spring(),value: isShowing).onDisappear {
                curHeight = minHeight
            }.gesture(dragGesture)
    }
